...
ActiveRecord::Schema.define(version: 20170117205057) do
  ...
  add_index "bookings", ["resource_type_id"], name: "index_bookings_on_resource_type_id"
  add_index "bookings", ["user_id"], name: "index_bookings_on_user_id_and_resource_id"
